...
<style lang="postcss">
  ...
  figure code {
	...
	/* figure button {
		@apply absolute bottom-0 right-0 text-xs font-semibold p-2 bg-gray-600 text-gray-100 rounded-full;
  } */
